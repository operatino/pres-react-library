  ...
  render() {
    return (
      <Deck transition={["slide", "spin"]} transitionDuration={800} progress={"number"}>
        ...
        <Slide transition={["fade"]} bgColor="secondary" textColor="primary" align="flex-start center">
          <List margin="-100px 0 0" textSize="1.5em">
            <ListItem><Link href="http://callemall.github.io/material-ui" textColor="primary">Material UI</Link></ListItem>
            <ListItem><Link href="http://nikgraf.github.io/belle" textColor="primary">Belle</Link></ListItem>
            <ListItem><Link href="http://elemental-ui.com/" textColor="primary">Elemental UI</Link></ListItem>
            <ListItem><Link href="http://react-components.com/" textColor="primary">React Components (collection)</Link></ListItem>
          </List>
        </Slide>


        <Slide bgColor="black" transition={["slide"]} bgImage={images.componetizing.replace("/", "")} bgDarken={0.75}>
          <Heading size={1} caps fit textColor="primary" margin="-60px 0 0">
            Componetizing
          </Heading>
          <Heading size={2} caps fit textColor="tertiary">
        ...
        <Slide bgColor="black" transition={["slide"]} bgImage={images.composable.replace("/", "")} bgDarken={0.75}>
        ...
        <Slide transition={["fade"]} bgColor="black">
          <BlockQuote>
            <Quote textSize="3em" style={{lineHeight: "1.3"}}>I want you to take a moment and forget everything you know about web development.<br/>
        ...
        <Slide transition={["fade"]} bgColor="secondary" textColor="primary" align="flex-start center">
          <List margin="-100px 0 0" textSize="1.5em">
            <ListItem><Link href="http://projects.formidablelabs.com/radium/" textColor="primary">Radium</Link></ListItem>
            <ListItem><Link href="https://github.com/js-next/react-style" textColor="primary">React Style</Link></ListItem>
        ...
        <Slide bgColor="white" align="flex-start flex-start">
            <Link href="http://projects.formidablelabs.com/component-playground/"><Image src={images.playground.replace("/", "")} width="80%" /></Link>
        </Slide>


        <Slide bgColor="secondary" textColor="primary" align="flex-start center" bgImage={images.puzzle.replace("/", "")} bgDarken={0.75}>
